...
def get_cpu_temperature():
    try:
        response = requests.get("http://localhost:5123/api/hardware/cpu", timeout=2)
                ...
                content=ft.Column(
                    [
                        ...
                        ft.Row([
                            ...
                            ft.Text("835 Pts", size=12, weight="bold", color="#ffffff")
                        ], alignment="spaceBetween"),
                        ft.Row([
                            ft.Text(translate("temperature"), size=12, color="#cccccc"),
                            ft.Text("75 °C", size=12, color="#ffffff")
                        ], alignment="spaceBetween"),
                        ft.Row([
                            ft.Text(translate("total_time"), size=12, color="#cccccc"),
                            ft.Text("732 sec", size=12, color="#ffffff")
                        ], alignment="spaceBetween"),
                        ft.Row([
